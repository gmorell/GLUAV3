...
DATABASES = {
    'default': {
        ...
        'USER': creds.username,                      # Not used with sqlite3.
        'PASSWORD': creds.password,                  # Not used with sqlite3.
...
SECRET_KEY = 'pvme09hugt2sbg3*hu*g5hlyd%yi+8xokd%%_#_d)t+2uawiv!'
...
ROOT_URLCONF = 'GLUAV3.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'GLUAV3.wsgi.application'
